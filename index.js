...
router.get('/myinfoV2', function(req, res) {
		var body;
...
router.post('/listMeetingV2', function(req, res) {
  console.log(req.body);
  console.log("id:", req.body.id);
  ...
  // make an asynchronous request to zoom to list all meetings
  var asyncres = thenrequest('GET',"https://api.zoom.us/v2/users/"+user_id+"/meetings",Moptions).done(function (res) {
    console.log(res.getBody('utf8'));
    });
  res.redirect('/');
});
